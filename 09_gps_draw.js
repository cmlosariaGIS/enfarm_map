...
var draw = new ol.interaction.GeolocationDraw({
    ...
    //type: "LineString", // Hard code the drawing type to "Polygon" //other values: "Point" and "LineString"
    //followTrack: true, // Hard code followTrack to true /other values: false, auto, position, visible
    zoom: 18,
